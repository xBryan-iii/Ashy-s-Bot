...
client.on('message', message => {
    ...
    switch(args[0]) {
        ...
        case 'answer':
            if (!message.content.startsWith(PREFIX)) return
            if (!message.member.roles.find(role => role.id === "610947465570418713")) return message.channel.send(`Error occured! ${message.author}, this command is only for people with the role ${client.guilds.get('610936256062291968').roles.find(role => role.id === "610947465570418713")}.`)
